!function (a, b) {
    b["true"] = a, textAngularSetup = angular.module("textAngularSetup", []), textAngularSetup.value("taOptions", {
    ...
    }), textAngularSetup.value("taSelectableElements", ["a", "img", "embed", "iframe", "object"]), textAngularSetup.value("taCustomRenderers", [{
        selector: "img",
        ...
        a("html", {
            buttontext: c.toggleHTML, action: function () {
        ...
        angular.forEach(["h1", "h2", "h3", "h4", "h5", "h6"], function (b) {
            ...
            buttontext: "embed", action: function () {
                return this.$editor().wrapSelection("formatBlock", "<embed>")
            }, activeState: function () {
                return this.$editor().queryFormatBlockState("embed")
            }

        }), a("pre", {
            buttontext: "pre", action: function () {
                return this.$editor().wrapSelection("formatBlock", "<PRE>")
            }, activeState: function () {
                return this.$editor().queryFormatBlockState("pre")
            }
        }), a("ul", {
            iconclass: "fa fa-list-ul", action: function () {
                return this.$editor().wrapSelection("insertUnorderedList", null)
            }, activeState: function () {
                return document.queryCommandState("insertUnorderedList")
            }
        }), a("ol", {
            iconclass: "fa fa-list-ol", action: function () {
                return this.$editor().wrapSelection("insertOrderedList", null)
            }, activeState: function () {
                return document.queryCommandState("insertOrderedList")
            }
        }), a("quote", {
            iconclass: "fa fa-quote-right", action: function () {
                return this.$editor().wrapSelection("formatBlock", "<BLOCKQUOTE>")
            }, activeState: function () {
                return this.$editor().queryFormatBlockState("blockquote")
            }
        }), a("undo", {
            iconclass: "fa fa-undo", action: function () {
                return this.$editor().wrapSelection("undo", null)
            }
        }), a("redo", {
            iconclass: "fa fa-repeat", action: function () {
                return this.$editor().wrapSelection("redo", null)
            }
        }), a("bold", {
            iconclass: "fa fa-bold", action: function () {
                return this.$editor().wrapSelection("bold", null)
            }, activeState: function () {
                return document.queryCommandState("bold")
            }, commandKeyCode: 98
        }), a("justifyLeft", {
            iconclass: "fa fa-align-left", action: function () {
            ...
            iconclass: "fa fa-align-right", action: function () {
            ...
            iconclass: "fa fa-align-center", action: function () {
            ...
            iconclass: "fa fa-italic", action: function () {
                return this.$editor().wrapSelection("italic", null)
            }, activeState: function () {
                return document.queryCommandState("italic")
            }, commandKeyCode: 105
        }), a("underline", {
            iconclass: "fa fa-underline", action: function () {
                return this.$editor().wrapSelection("underline", null)
            }, activeState: function () {
                return document.queryCommandState("underline")
            }, commandKeyCode: 117
        }), a("clear", {
            iconclass: "fa fa-ban", action: function (a, b) {
        ...
        a("insertImage", {
            iconclass: "fa fa-picture-o", action: function () {
                var a;
                return a = b.prompt(c.insertImage, "http://"), a && "" !== a && "http://" !== a ? this.$editor().wrapSelection("insertImage", a, !0) : void 0
            }, onElementSelect: {element: "img", action: g}
        }),

            a("insertVideo", {
            iconclass: "fa fa-youtube-play", action: function () {
                var a;
                if (a = b.prompt(c.insertVideo, "http://"), a && "" !== a && "http://" !== a) {
                    var d = a.match(/(\?|&)v=[^&]*/);
                    if (d.length > 0) {
                        var e = "http://www.youtube.com/embed/" + d[0].substring(3);
                        var f = '<div ta-bind ng-model="htmlcontent">';

                        //LINK CON ETIQUETA IMAGEN
                        //f+= '<a target="_blank" href="https://www.youtube.com/watch?v='+d[0].substring(3)+'">';
                        //f+= '<img class="ta-insert-video" ta-insert-video="'+e+'" contenteditable="false" src="http://img.youtube.com/vi/'+d[0].substring(3)+'/0.jpg" allowfullscreen="true" width="300" frameborder="0" height="250"/>';
                        //f+= '</a>';

                        //TAG IFRAME
                        //f = '<iframe width="651" height="396" src="http://www.youtube.com/v/'+d[0].substring(3)+'"></iframe>';

                        //TAG OBJECT
                        //f = '<object width="651" height="396" data="http://www.youtube.com/v/'+d[0].substring(3)+'"></object>';

                        //TAG EMBED
                        f+= '<embed class="ta-insert-video" ta-insert-video="'+e+'" width="651" height="396" contenteditable="false" src="http://www.youtube.com/v/'+d[0].substring(3)+'" allowfullscreen="true" frameborder="0" />';
            ...
            }, onElementSelect: {element: "img", onlyWithAttrs: ["ta-insert-video"], action: g}
            //}, onElementSelect: {element: "embed", onlyWithAttrs: ["ta-insert-video"], action: g}
        }), a("insertLink", {
            iconclass: "fa fa-link", action: function () {
                var a;
                return a = b.prompt(c.insertLink, "http://"), a && "" !== a && "http://" !== a ? this.$editor().wrapSelection("createLink", a, !0) : void 0
            }, activeState: function (a) {
                return a ? "A" === a[0].tagName : !1
            }, onElementSelect: {
                element: "a", action: function (a, d, e) {
        ...
        l.constant("taRegisterTool", c), l.value("taTools", m), l.config([function () {
            ...
            return {
                require: "?ngModel", scope: {}, restrict: "EA", link: function (d, l, m, n) {
            ...
            var d = /(address|article|aside|audio|blockquote|canvas|dd|div|dl|fieldset|figcaption|figure|footer|form|h1|h2|h3|h4|h5|h6|header|hgroup|hr|noscript|ol|p|section|table|tfoot|ul|embed|iframe|object|pre|output|video)/gi, e = /(ul|li|ol)/gi, f = function (b, c) {
                var d, e = b.find("li");
            ...
            return {
                require: "ngModel", scope: {}, link: function (j, o, p, q) {
